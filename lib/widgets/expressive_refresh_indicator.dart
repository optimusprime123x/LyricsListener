...
class ExpressiveRefreshIndicator extends StatefulWidget {
  ...
  /// Text to display inside the indicator's polygon.
  final String? statusText;

  /// Text to display below the indicator.
                ...
                child: Align(
                  ...
                  child: ScaleTransition(
                    ...
                    child: Column(
                      ...
                      children: [
                        _buildIndicator(context, showIndeterminateIndicator),
...
class _ExpressiveLoadingIndicatorImpl extends StatefulWidget {
  ...
  final String? semanticsValue;
  final String? statusText;
  final Animation<double> positionFactor;
        ...
        child: ConstrainedBox(
          ...
          child: AspectRatio(
            ...
            child: AnimatedBuilder(
              animation: Listenable.merge([_morphController, _globalRotationController, widget.positionFactor]),
